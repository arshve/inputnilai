                    ...
                    <div class="col-md-12">
                        <div class="text-center visible-lg">
                            <ul id="hornavmenu" class="nav navbar-nav">
                               ...
                               <li>
                                    <a href="konten/konten-index.php" class="fa-user-md">Konten Admin</a>
                                </li>
                                <li>
            ...
            <div class="container">
                <div class="row margin-vert-40">
                    ...
                    <div class="col-md-12">
                        ...
                        <p class="text-center">Sebagai Admin anda memiliki akses untuk menambahkan User dan Mata Kuliah</p>
                        <img class="fadeInUp animate" alt="" src="img/jugger.png" style="display: block; margin-left: auto; margin-right: auto; margin-top: 40px;">
                    </div>
                    <!-- End Main Text -->
                </div>
            </div>
                   ...
                   <!-- Footer Menu -->
                    <div id="footermenu" class="col-md-8">
                        <ul class="list-unstyled list-inline">
                            ...
                            <li>
                                <a href="konten/konten-index.php" target="_blank">Konten Admin</a>
                            </li>
                            <li>
