                    ...
                    <div class="col-md-12">
                        <div class="text-center visible-lg">
                            <ul id="hornavmenu" class="nav navbar-nav">
                               ...
                               <li>
                                    <a href="konten/konten-index.php" class="fa-user-md">Konten Dosen</a>
                                </li>
                                <li>
        ...
        <div id="welcome" class="background-white">
            <div class="container">
                <div class="row margin-vert-40">
                    <!-- Main Text -->
                    <div class="col-md-12">
                        <h2 class="text-center article-title">Welcome Admin</h2>
                        <p class="text-center">Sebagai Dosen anda memiliki akses untuk memasukan nilai</p>
                        <img class="fadeInUp animate" alt="" src="img/rubick.png" style="display: block; margin-left: auto; margin-right: auto; margin-top: 40px;">
                    </div>
                    <!-- End Main Text -->
                </div>
            </div>
                   ...
                   <!-- Footer Menu -->
                    <div id="footermenu" class="col-md-8">
                        <ul class="list-unstyled list-inline">
                            ...
                            <li>
                                <a href="konten/konten-index.php" target="_blank">List Mahasiswa</a>
                            </li>
                            <li>
                                <a href="konten/konten-index.php" target="_blank">Management Nilai</a>
                            </li>
                            <li>
