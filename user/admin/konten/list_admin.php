...
<tr>
	...
	<th style="text-align:center;" width="100">No.Admin</th>
	<th style="text-align:center;" width="auto">Nama Admin</th>
...
<tr class="table-striped">
    ...
    <td align="center" width="80"><a href="?module=set_dosen&id=<?php echo $buff['id'];?>">
	<input class="btn btn-default" type="submit" value="Dosen"/></a></td>
    <td align="center" width="50"><a href="?module=edit_admin&id=<?php echo $buff['id'];?>">
        <button class="btn btn-info"><span class="glyphicon glyphicon-pencil"></span></button></a>
    </td>
	<td align="center" width="50"><a href="?module=del_admin&id=<?php echo $buff['id'];?>">
