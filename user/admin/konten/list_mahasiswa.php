...
<tr class="table-striped">
    ...
    <td align="center" width="80"><a href="?module=set_admin&id=<?php echo $buff['id'];?>">
    ...
    <td align="center" width="50"><a href="?module=edit_mahasiswa&id=<?php echo $buff['id'];?>">
        <button class="btn btn-info"><span class="glyphicon glyphicon-pencil"></span></button></a>
    </td>
	<td align="center" width="50"><a href="?module=del_mahasiswa&id=<?php echo $buff['id'];?>">
